            ...
            <div id="projects">
                ...
                <div id="projects-items" data-aos="fade-up">
                    <div>
                        ...
                        <div id="icons">
                            <a href="https://frontend-taupe-six.vercel.app/" target={"_blank"}><ion-icon name="eye"></ion-icon></a>
                            <a href="https://github.com/vrishabh081/company_assignment_1" target={"_blank"}><ion-icon name="logo-github"></ion-icon></a>
                        </div>
                    </div>
                    <div id="image-div">
